  ...
  return (
    <div className="w-full min-w-0 space-y-6">
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-500">Add document</h2>
        <form onSubmit={create} className="mt-3 grid gap-2 md:grid-cols-4">
          <label className="md:col-span-2" htmlFor="compliance-document-name">
            ...
            <input id="compliance-document-name" className="input-modern rounded-xl" value={name} onChange={(e) => setName(e.target.value)} />
          </label>
      ...
      <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm">
        <div className="border-b border-neutral-200/80 px-5 py-4"><h2 className="text-base font-semibold text-security-navy-900">Document vault</h2></div>
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-neutral-200 text-sm" aria-busy={loading}>
            ...
            <thead><tr className="text-[11px] uppercase tracking-wide text-neutral-500"><th scope="col">Name</th><th scope="col">Type</th><th scope="col">Status</th><th scope="col">Expiry</th><th scope="col" className="text-right">Action</th></tr></thead>
            <tbody>
              {loading ? (
