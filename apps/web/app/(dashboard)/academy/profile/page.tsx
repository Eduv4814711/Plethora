    ...
    <div className="module-shell space-y-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="label-text mt-1 lg:mt-0">Module · Academy</p>
          <h1 className="page-title mt-1">Profile</h1>
          <p className="text-sm text-black">Manage your training provider and organisation information.</p>
        </div>
        {canEdit && isEditing && (
          <button
            type="submit"
      ...
      {saveMessage && (
        <div className="notice-success flex flex-wrap items-center justify-between gap-2 text-sm">
      ...
      <form
        ...
        onSubmit={submit}
        className="card-wireframe space-y-5 p-5 md:p-6"
      >
