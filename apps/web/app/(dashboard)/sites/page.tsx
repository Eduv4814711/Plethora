...
export default function SitesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {sites.length === 0 && (
        <div className="text-center py-16 px-6 rounded-sm border-2 border-dashed border-neutral-200 dark:border-neutral-700 bg-neutral-50/50 dark:bg-neutral-900/30">
          ...
          <p className="font-semibold text-neutral-700 dark:text-neutral-300">No sites registered</p>
...
function SiteCard({
  ...
  return (
    <div
      ...
      className="group p-6 bg-white dark:bg-neutral-900 rounded-sm border border-neutral-200 dark:border-neutral-800 shadow-sm hover:shadow-lg hover:border-neutral-300 dark:hover:border-neutral-700 transition-all duration-200 cursor-pointer"
    >
        ...
        {isAdmin && (
          <div className="flex items-center gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              className="p-2 rounded-lg text-neutral-500 hover:text-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-900/20 transition-colors"
              title="Edit site"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function SiteForm({
  ...
  return (
    <form
      ...
      className="p-6 bg-white dark:bg-neutral-900 rounded-sm border border-neutral-200 dark:border-neutral-800 shadow-lg"
    >
      ...
      {error && (
        <div className="mb-6 p-4 text-sm text-neutral-600 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-900/20 rounded-sm">
          {error}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className="border border-neutral-200 dark:border-neutral-700 rounded-sm p-4 bg-neutral-50/50 dark:bg-neutral-800/30 max-h-40 overflow-y-auto">
            {guards.length === 0 ? (
      ...
      <div className="mt-6 flex gap-3">
        <button
          type="button"
          onClick={onCancel}
          className="px-5 py-2.5 font-medium rounded-sm border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
        >
          Cancel
        </button>
...
function EditSiteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-neutral-900 rounded-sm shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col border border-neutral-200 dark:border-neutral-800">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 space-y-6">
          {error && (
            <div className="p-4 text-sm text-neutral-600 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-900/20 rounded-sm">
              {error}
            </div>
          )}
          ...
          <div className="flex gap-3 pt-2">
            <button type="button" onClick={onClose} className="flex-1 py-2.5 font-medium rounded-sm border border-neutral-200 dark:border-neutral-700 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors">
              Cancel
            </button>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-neutral-900 rounded-sm shadow-2xl w-full max-w-md border border-neutral-200 dark:border-neutral-800">
        <div className="p-6">
          ...
          {error && (
            <div className="mt-4 p-3 text-sm text-neutral-600 dark:text-neutral-400 bg-neutral-50 dark:bg-neutral-900/20 rounded-sm">
              {error}
            </div>
          )}
          <div className="mt-6 flex gap-3">
      ...
      {show ? (
        <form onSubmit={handleSubmit} className="flex gap-2 items-end flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium border border-neutral-200 dark:border-neutral-700 rounded-sm hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
          >
            Cancel
          </button>
        </form>
