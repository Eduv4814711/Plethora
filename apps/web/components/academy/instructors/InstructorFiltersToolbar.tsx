      ...
      <div className="rounded-security-lg border border-security-navy-100 bg-white/90 p-2 shadow-security-card">
        <div className="overflow-x-auto">
          <div className="flex flex-col gap-2 xl:flex-row xl:min-w-0 xl:flex-nowrap xl:items-center">
            <input
              className="input-compact w-full min-w-0 rounded-lg xl:w-64 xl:min-w-[16rem]"
            ...
            <button type="button" className="btn-ghost px-3 py-1.5 text-xs w-full rounded-lg xl:w-auto" onClick={onReset}>
              Reset
            </button>
          </div>
        </div>
...
function CompactSelect({
  ...
  return (
    <select
      className="input-compact w-full min-w-0 rounded-lg xl:w-auto xl:min-w-36"
      value={value}
