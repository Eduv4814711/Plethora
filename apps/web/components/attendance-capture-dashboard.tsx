    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="rounded-lg border border-neutral-200 bg-white px-3 py-2 text-xs text-neutral-600 shadow-sm dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-300">
          ...
          <span className="block mt-0.5">{formatDisplayDate(overview.asOfDate)}</span>
        </div>
      </div>
      ...
      {needsCapture.length > 0 ? (
        <div className="mt-4 overflow-hidden rounded-lg border border-amber-200/70 dark:border-amber-900/40">
        ...
        <div className="mt-4 rounded-lg border border-emerald-200/80 bg-emerald-50/70 px-4 py-3 text-sm text-emerald-900 dark:border-emerald-900/40 dark:bg-emerald-950/20 dark:text-emerald-100">
