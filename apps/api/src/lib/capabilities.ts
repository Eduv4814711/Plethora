...
export const CAPABILITY_CATALOG: readonly CapabilityDefinition[] = [
  ...
  { path: "/compliance", label: "Compliance", capabilities: ["view", "view_sensitive", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/statutory", label: "Compliance · Statutory", parent: "/compliance", capabilities: ["view", "view_sensitive", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/funds", label: "Compliance · Funds", parent: "/compliance", capabilities: ["view", "view_sensitive", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/legal", label: "Compliance · Legal", parent: "/compliance", capabilities: ["view", "view_sensitive", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/cash-control", label: "Compliance · Cash Control", parent: "/compliance", capabilities: ["view", "view_sensitive", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/company", label: "Compliance · Company Register", parent: "/compliance", capabilities: ["view", "create", "edit", "delete", "approve", "export"] },
  { path: "/compliance/reports", label: "Compliance · Reports", parent: "/compliance", capabilities: ["view", "export"] },
