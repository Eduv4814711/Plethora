...
5. Review the owner selection and converted capability assignments in `20260723120000_capability_access` before deployment. The migration preserves legacy effective access, selects one deterministic owner per company, and removes the former authorization columns.
